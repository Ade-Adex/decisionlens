...
export default function InfoCard({ icon, title, text }: InfoCardProps) {
  return (
    <div className="bg-white rounded-xl p-8 text-center shadow-lg border border-slate-100 hover:shadow-xl transition flex flex-col items-center">
      <div className="w-16 h-16 rounded-full bg-[#0f2348] flex items-center justify-center mb-6">
        {icon}
      </div>

      <h3 className="font-bold text-lg text-[#0f2348] mb-2">{title}</h3>
